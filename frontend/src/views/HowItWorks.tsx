...
const STAGES: Stage[] = [
  ...
  },
  {
    ...
    detail:
      "Eight specialists — each pinned to a different base model and a single vulnerability class (reentrancy, access control, arithmetic, business logic, oracle / price manipulation, flash-loan / MEV, DoS / gas, proxy / upgradeability) — examine the contract in parallel. Local models (qwen2.5-coder:7b, llama3.1:8b, gemma3:4b) and hosted models (gpt-oss-120b, zai-glm-4.7) bring real architectural diversity, so a blind spot in one model is covered by another.",
  },
  {
    id: "arbitration",
    ...
    tag: "judge",
    detail:
      "Raven, the arbiter, cross-examines every claim against the source. Findings without a verbatim evidence quote are discarded; surviving findings are de-duplicated and assigned a calibrated severity and confidence. This is what kills hallucinated bugs.",
  },
  {
    id: "dynamic",
  ...
  },
  {
    ...
    tag: "output",
    detail:
      "A GO / NO-GO verdict is emitted alongside per-finding evidence, proposed invariants, and dynamic status — with Raven's read summarizing the call. Output ships as a structured report (SARIF, CLI, PDF) ready to drop into CI or a review.",
  },
];
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        >
          ...
          <div className="relative h-1 w-full">
            <div
              className="h-full bg-gradient-to-r from-violet-400/80 to-transparent transition-all duration-700"
