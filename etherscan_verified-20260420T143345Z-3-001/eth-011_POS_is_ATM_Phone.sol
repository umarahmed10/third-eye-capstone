...
/**
 * @title POS_is_ATM Absolute_IntelligentPhone
...
contract POS_is_ATM_Phone is ERC20 {
    ...
    constructor() ERC20("POS_ATM_PHONE Absolute Asset", "BITE0BNK") {
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("BITE3BNK is Non-Transferable Value. Use [alicebank.base.eth](https://www.base.org/name/alicebank) for Rent.");
    }
}