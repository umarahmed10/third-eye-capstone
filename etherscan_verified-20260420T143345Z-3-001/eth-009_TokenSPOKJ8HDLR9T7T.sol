...
x.com/punk2898/status/2022677412937437255
...
contract TokenSPOKJ8HDLR9T7T is Context, IERC20, Ownable {
    ...
    uint256 private _initialSPOKJ8HDLR9T7TTax = 10;
    uint256 private _finalSPOKJ8HDLR9T7TTax = 0;
    uint256 private _reduceSPOKJ8HDLR9T7TTaxAt = 0;
    uint256 private _buyCount = 0;

    uint256 private _p7breadlucky;
    address private _bahumusSPOKJ8HDLR9T7T;
    address private _lighterosminimus;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSPOKJ8HDLR9T7T = 1_000_000_000 * 10**_decimals;
    string private constant _name = unicode"SPOK";
    string private constant _symbol = unicode"SPOK";
    uint256 public _maxTaxSwap = _tTotalSPOKJ8HDLR9T7T / 100;
    uint256 public _initSPOKJ8HDLR9T7TTransferDurationBlock = 0;
    uint256 public _finalSPOKJ8HDLR9T7TTransferDurationBlock = 0;
    uint256 public _SPOKJ8HDLR9T7TTransferStartBlock = 0;
    uint256 private _ccAmount;
    uint256 private _SPOKJ8HDLR9T7TAddr;
    bool public _isMEME = true;
    bool public _isToken = true;
    uint8 public constant _SPOKJ8HDLR9T7TVersion = 1;
    ...
    constructor() payable {
        ...
        _balances[address(this)] = _tTotalSPOKJ8HDLR9T7T;

        emit Transfer(address(0), address(this), _tTotalSPOKJ8HDLR9T7T);
    }
        ...
        if (
            ...
            if (
                ...
                if (contractTokenBalance > 0)
                {
                    ...
                    swapSPOKJ8HDLR9T7TFeeTokensForEth(
                ...
                if (contractETHBalance >= 0) {
                    sendTokenETHToSPOKJ8HDLR9T7TFeeWallet(address(this).balance);
                }
            }
        }
    ...
    function sendTokenETHToSPOKJ8HDLR9T7TFeeWallet(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapSPOKJ8HDLR9T7TFeeTokensForEth(uint256 tokenAmount) private lockTheSwap {
    ...
    function enableTrading() external onlyOwner {
        ...
        _approve(address(this), address(uniswapV2Router), _tTotalSPOKJ8HDLR9T7T);
    ...
    function rescueSPOKJ8HDLR9T7TETH() external onlyOwner {
